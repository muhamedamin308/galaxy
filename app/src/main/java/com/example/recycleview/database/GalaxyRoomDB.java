        ...
        protected Void doInBackground(Void... voids) {
            mgalaxyDao.insert(new Planet(
                    ...
                    "Mercury is only slightly larger than Earth's Moon. \n" +
                            ...
                            " thanks to its dense atmosphere. Because of Mercury's elliptical – egg-shaped – orbit, and sluggish rotation," +
                            " the Sun appears to rise briefly, set, and rise again from some parts of the planet's surface." +
            ...
            mgalaxyDao.insert(new Planet(
                    ...
                    "While Earth is only the fifth largest planet in the solar system, it is the only world in our solar system with liquid water on the surface." +
                            ...
                            " The name was taken from Old English and Germanic. It simply means \"the ground.\" There are," +
                            " of course, many names for our planet in the thousands of languages spoken by the people of the third planet from the Sun.",
                    6371,
                    "Terrestrial",
                    365));
            ...
            mgalaxyDao.insert(new Planet(
                    ...
                    "More than 30 times as far from the Sun as Earth," +
                            " Neptune is the only planet in our solar system not visible to the naked eye and the first predicted by" +
                            " mathematics before its discovery. In 2011 Neptune completed its first 165-year orbit since its discovery in 1846.\n" +
                            ...
                            "Neptune—the eighth and most distant major planet orbiting our Sun—is dark," +
                            " cold and whipped by supersonic winds. It was the first planet located through mathematical calculations.",
                    24622,
                    "Ice Giant",
                    60190));
            return null;
